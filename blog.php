...
<body>
    ...
    <header class="header text-center">	    
	    <h1 class="blog-name pt-lg-4 mb-0"><a href="index.html"><?php echo $user['name']?></a></h1>
	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				<div class="profile-section pt-3 pt-lg-0">
				    <img class="profile-image mb-3 rounded-circle mx-auto" src="upload/<?php echo $user['file']?>" alt="image" >			
					
					<div class="bio mb-3"><?php echo $user['name']?></a></div><!--//bio-->
    ...
    <div class="main-wrapper">
     ...
     ?>
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="upload/<?php echo $result['file']?>" alt="image">
					    <div class="media-body">
						    <h3 class="title mb-1"><a href="blog-post.html"><?php echo $result['name']?></a></h3>
